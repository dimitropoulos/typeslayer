...
export const Step0Prerequisites = () => {
  ...
  return (
    <Step step={0}>
      <Button startIcon={<Info />} variant="outlined" onClick={toggleDialog}>
        prerequisites
      </Button>
      <Dialog open={open} onClose={toggleDialog} fullWidth maxWidth="md">
        ...
        <DialogContent>
          <Stack spacing={2}>
            <Step step={1}>
              <Stack spacing={0.5}>
                ...
                <Typography>
                  ...
                  <InlineCode secondary>tsc --noEmit</InlineCode> from{" "}
            ...
            <Typography>
              did you notice all three of those steps are basically saying the
              same thing in three different ways? your project needs to have
              some place where you can run{" "}
              <InlineCode secondary>tsc --noEmit</InlineCode> and process all
            ...
            <Step step={4}>
              <Stack spacing={0.5}>
                ...
                <Typography>
                  ...
                  . but if there are problems: those problems can from from
                  anywhere in your total build.{" "}
                </Typography>
                <Typography>
                  so, if you find yourself thinking "but I just want to look at{" "}
                  <em>my types</em> not all these 3rd party types": consider
                  that when building and/or typechecking your project there
                  literally is no such thing as "3rd party". if you pull in a
                  dependency that has problems..{" "}
